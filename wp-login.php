...
<link rel='stylesheet' href='https://blog.running-sunny.com/wp-admin/load-styles.php?c=0&amp;dir=ltr&amp;load%5B%5D=dashicons,buttons,forms,l10n,login&amp;ver=4.7.2' type='text/css' media='all' />
...
<form name="loginform" id="loginform" action="https://blog.running-sunny.com/wp-login.php" method="post">
	<p>
	...
	<p class="submit">
		...
		<input type="hidden" name="redirect_to" value="https://blog.running-sunny.com/wp-admin/" />
		<input type="hidden" name="testcookie" value="1" />
	</p>
</form>

<p id="nav">
	<a href="https://blog.running-sunny.com/wp-login.php?action=lostpassword">忘了密碼？</a>
</p>
...
if(typeof wpOnload=='function')wpOnload();
	...
	<p id="backtoblog"><a href="https://blog.running-sunny.com/">&larr; 返回 Running Sunny</a></p>
